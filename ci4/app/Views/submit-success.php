...
<div class="container-lg">
    <h1 class="mt-3">Thank you for your submission!</h1>
    
    <p>What happens next:</p>
    <p>All submissions go through a brief editorial process and are then queued for publication.<br>
    we usually publish new work every Sunday evening depending on the volume of submissions.</p>
